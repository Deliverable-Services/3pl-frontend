...
@Component({
  selector: "app-shipment-and-shipping-list",
  templateUrl: "./shipment-and-shipping-list.component.html",
  styleUrls: ["./shipment-and-shipping-list.component.scss"],
})
export class ShipmentAndShippingListComponent implements OnInit {
  ...
  setPageParams(pageParam: PageParam) {
    this.shippingOrderService.setPageParams(pageParam);
    this.getTransferOrderList();
  }
