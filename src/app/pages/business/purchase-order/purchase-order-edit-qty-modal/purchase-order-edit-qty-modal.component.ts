...
@Component({
  selector: "app-purchase-order-edit-qty-modal",
  templateUrl: "./purchase-order-edit-qty-modal.component.html",
  styleUrls: ["./purchase-order-edit-qty-modal.component.scss"],
})
export class PurchaseOrderEditQtyModalComponent {
  @Input() data: any;
