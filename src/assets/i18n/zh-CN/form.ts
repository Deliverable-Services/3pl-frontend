export default {
  ...
  'form': {
    ...
    purchaseOrder: {
      ...
      popupBtn: "选择有风格的产品",
      buttons: { publish: '发布', confirm: '确认', ship: '船', cancel: '取消', remove: '消除', 
      ready: '准备好', reject: '拒绝', release: '发布', close: '关闭', shipmentDetails: '物流信息' }
    },
    sAndS: {
      title2: "物流信息",
      title3: "包装细节",
      ...
      extraFields: { cartonTrackingNo: '纸箱追踪号码', cartonNo: '纸箱号', length: '长度（厘米）', width: '宽度（厘米）', height: '身高（厘米）',
      cbm: '煤层气', grossWeight: '毛重（公斤）', netWeight: '净重/公斤）', numberOfCartons: '纸箱数量', 
      qtyInOneCartons: '一箱数量', totalPackedQty: '总包装数量' },
      buttonTitle: "创建装运订单",
      editButtonTitle: "裝貨單",
      popupBtn: "从采购订单中选择产品",
      popupBtn2: "创建新纸箱",
      ...
      buttons: { publish: '发布', confirm: '确认的', ship: '船', cancel: '取消', remove: '消除', dispatching: '调度' }
    },
    vendor:{
      title: "小贩",
      title2: "银行明细",
