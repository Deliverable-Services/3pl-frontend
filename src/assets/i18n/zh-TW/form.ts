  ...
  'form': {
    ...
    purchaseOrder: {
      ...
      fields: {
        vendor: "小販",
        destination: "目的地",
        shippingToDepartment: "運送至部門",
        billAddress: "帳單地址",
        shippingAddress: "收件地址",
        expectedArrivalDate: "到期日",
        expectedDeliveryDate: "發行日期",
        publish: "發布",
        confirm: "確認",
        ship: "船",
        cancel: "取消",
        ...
        receivedQty: "收到數量",
        lockedQuantity: "鎖定數量",
        receivedQuantity: "收到數量",
        productPrice: '價格（新元',
        sampleStatus: '樣品狀態',
        totalProductPrice: '產品總價'
      },
      buttonTitle: "建立採購訂單",
      editButtonTitle: "採購訂單",
      popupBtn: "選擇有風格的產品",
      buttons: { publish: '發布', confirm: '確認', ship: '船', cancel: '取消', remove: '消除', 
      ready: '準備好', reject: '拒絕', release: '發布', close: '關閉', shipmentDetails: '物流資訊' }
    },
    sAndS: {
      title2: "物流資訊",
      title3: "包裝細節",
      ...
      extraFields: { cartonTrackingNo: '紙箱追蹤號碼', cartonNo: '紙箱號', length: '長度（公分）', width: '寬度（公分）', height: '身高（公分）',
      cbm: '煤炭層氣', grossWeight: '毛重（公斤）', netWeight: '淨重/公斤）', numberOfCartons: '紙箱數量', 
      qtyInOneCartons: '一箱數量', totalPackedQty: '總包裝數量' },
      buttonTitle: "建立出貨訂單",
      editButtonTitle: "装货单",
      popupBtn: "從採購訂單中選擇產品",
      popupBtn2: "建立新紙箱",
      ...
      buttons: { publish: '發布', confirm: '確認的', ship: '船', cancel: '取消', remove: '消除', dispatching: '調度' }
    },
    vendor:{
      title: "小販",
      title2: "銀行明細",
