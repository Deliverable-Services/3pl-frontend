export default {
  list: {
    ...
    currency: {
      ...
      buttonTitle: "添加貨幣",
      searchOne: '搜尋貨幣代碼',
      table: {currencyName: '貨幣名稱', currencyCode: '貨幣代碼', rate: '速度'}
    },
    creditTerms: {
      title: "信貸條款",
      list: "信用條款清單",
      buttonTitle: "添加信用條款",
      table: {subject: '主題', details: '細節', creditDay: '信用日'}
    },
    connectionLocationList: {
      title: "連接位置",
      list: "連接位置列表",
      buttonTitle: "添加連接位置",
      table: {nodeName: '節點名稱', nodeType: '節點類型', lGStoreOwnerId: 'LG 店主 ID', lGWMSID: 'LG WMS ID', shopifyLocationId: 'Shopify 位置 ID',
    ...
    shopifyConnector: {
      ...
      table: {connectorName: '连接器名称', baseURL: '基本网址', token: '代币'}
    },
    inventory: {
      title: "庫存",
      dropdown: "選擇庫存節點",
    ...
    inventoryOnlineList: {
      title: "在線交叉檢查",
      dropdown: "選擇庫存節點",
      stockOwnerId: "庫存擁有者ID",
      color: "顏色",
      warehouseId: "倉庫ID",
      wmsAvailableQty: "WMS 可用數量",
      wmsQcQty: "WMS 品檢數量",
      wmsLockedQty: "WMS 鎖定數量",
      shpSohQty: "店鋪庫存數量",
      shpAvlQty: "店鋪可用數量",
      shpCommittedQty: "店鋪待發數量",
      shpReservedQty: "店鋪預留數量",
      size: "尺碼",
      sku: "SKU",
      shopifyVariantId: "Shopify 變體ID",
      styleName: "款式名稱",
      skuSearch: "通過SKU搜索",
      styleSearch: "通過款式名稱搜索",
      list: "在線庫存清單",
    },
    userManagement: {
      title: '用戶管理',
    ...
    user: {
      ...
      searchThree: '按標題搜尋',
      searchFour: '選擇一個群組',
      table: {userId: '使用者身分', username: '使用者名稱', department: '部門', title: '標題', group: '團體', roles: '角色'}
    },
    basicList: {
      title: "基本清單",
    ...
    cardList: {
      title: "卡片列表",
      description: "信息可以卡片形式展示，支持搜索功能。",
    },
    editableList: {
      title: "可編輯列表",
      description: "支持表格擴展和表格編輯。",
    },
    advanceList: {
      title: "預先清單",
      description:
        "允許用戶選擇列表中的多個項目並批量刪除它們。 允許用戶通過拖動來調整列寬。 支持虛擬滾動、延遲加載和過濾。",
    },
    treeList: {
      title: "樹列表",
      description: "支持樹表渲染。",
